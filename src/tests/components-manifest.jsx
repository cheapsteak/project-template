...
export default {
  ...
  'parallax-video-science': require('./parallax-video/computer-science'),
  'parallax-video-computer-science': require('./parallax-video/computer-science'),
  'parallax-video-computer-electives': require('./parallax-video/electives'),
  ...
  'chapter-video-player': require('./chapter-video-player/chapter-video-player.jsx'),
  'grid-manager': require('common/components/grid-manager/grid-manager.jsx'),
